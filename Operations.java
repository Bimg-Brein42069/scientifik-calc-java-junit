...
public class Operations {
    ...
    public static double factorial(double num) {
        ...
        if (num >= 0) {
            double result = factorialint((int) num);
            // //System.out.println("Result: " + result);
            return result;
        } else {
...
//        //System.out.println("Result: " + result + " radians");
    ...
    public static double arccos(double num) {
        ...
        double result = radiansToDegrees(Math.acos(num));
        // //System.out.println("Result: " + result);
        return result;
    }
    ...
    public static double arctan(double num) {
        ...
        double result = radiansToDegrees(Math.atan(num));
        // //System.out.println("Result: " + result);
        return result;
    }
    ...
    public static double harmnum(double num){
        ...
        if (num > 0) {
            ...
            //System.out.println("Error: Cannot calculate if n is non-positive.");
            return Double.NaN;
        }
    }
    ...
    public static double sumkofn(double num,double k){
        //System.out.println("Performing Sum of"+ k +"th power of n numbers Calculation: S" + k +"(" + num + ")" );
        if(num >= 0){
            //last def of res at num == 0
            double result = 0;
